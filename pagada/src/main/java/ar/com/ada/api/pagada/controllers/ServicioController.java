    ...
    public ResponseEntity<List<Servicio>> listarServicios(
        ...
        */
        ...
        public ResponseEntity<GenericResponse> pagarServicio(@PathVariable Integer id, @RequestBody InfoPagoRequest pago){
            ...
            OperacionPago pagoResult = servicioService.realizarPago(id,pago.importePagado, pago.moneda, pago.fechaPago, pago.medioPago, pago.infoMedioPago);
        ...
        //public ResponseEntity<GenericResponse> crearPago(@RequestBody InfoPagoRequest pago){
